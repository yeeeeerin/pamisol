...
public struct PinterestItem {
    ...
    var mutableString:NSAttributedString = NSMutableAttributedString()
    
    public init(image: UIImage, text: String, mutableString: NSAttributedString) {
        self.image = image
        self.text = text
...
open class PinterestVC: UICollectionViewController, PinterestLayoutDelegate {
    ...
    private func setupCollectionViewInsets() {
        collectionView!.backgroundColor = UIColor.gray //.clear
    ...
    public func collectionView(collectionView: UICollectionView,
                        ...
                        withWidth: CGFloat) -> CGFloat {
        let text = items[indexPath.item].mutableString.string
    ...
    override open func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
       ...
       // cell.descriptionLabel.text = item.text
        cell.descriptionLabel.attributedText = item.mutableString
